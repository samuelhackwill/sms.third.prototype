...
export const FAKE_MESSAGES = [
  ...
  'je voudrais que ca s arrete mais pas maintenant',
  'quand j etais petit je suis tombe amoureux d une personne mechante',
  'si tu lis ca : je te reconnais',
  'j ecris pour verifier que je suis encore vivant',
];
